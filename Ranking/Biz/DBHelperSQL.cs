...
namespace Ranking
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        //public static string connectionString = "server=.;database = ST_Store;uid = sa;pwd = sa";

        public static string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["Wtf"].ToString();
        public DbHelperSQL()
        {
        }


        public static void WriteLog(string _Desc, string value1)
        {
