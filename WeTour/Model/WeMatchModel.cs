...
namespace WeTour
{
    ...
    public class WeMatchModel
    {
        ...
        /// <summary>
        /// 比赛类型(单打，双打)，如果值为1，表示该比赛只是俱乐部内部临时比赛，不用做晋级处理，只需要增加积分
        /// 
        /// </summary>
        ...
        public string Player1Limage { get; set; }
        public string Player1Rname { get; set; }
        public string Player1Rimage { get; set; }
        public string Player2Lname { get; set; }
        public string Player2Limage { get; set; }
        public string Player2Rname { get; set; }
        public string Player2Rimage { get; set; }

        /// <summary>
        /// 单双打球员姓名
        /// </summary>
        public string Player1ComName { get; set; }
        /// <summary>
        /// 单双打球员姓名
        /// </summary>
        public string Player2ComName { get; set; }
