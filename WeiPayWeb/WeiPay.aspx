...
function ConfirmPay() {
    var orderid = document.getElementById('lblOrderSN').innerHTML;
    //orderid = '20150427205205001';
    alert(orderid);
    $("http://wetennis.cn/Handler/MemCenter.ashx?typename=UpdateTourApplyStatusbyOrderSys&ordersys=" + orderid, { i: Math.random() }, function (data) {
        alert('修改状态');
        location.href = '/Memcenter.htm';
    })
    }
